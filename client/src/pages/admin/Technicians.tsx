...
import { mapTechnician, type TechNode, type TechView } from "../../adapters/technician";

export default function Technicians() {
  const [selectedTech, setSelectedTech] = useState<TechView | null>(null);
        ...
        {!selectedTech ? (
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="p-4 xl:p-6 space-y-6 overflow-y-auto">
              ...
              {/* Assignment Form Panel — wired in Phase 5 */}
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-4 xl:p-5">
                ...
                <div className="space-y-4">
                  <div>
                    <label className="block text-xs font-medium text-fg mb-1">Select Job</label>
